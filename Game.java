...
public class Game {
  ...
  public void play(){
    ...
    if(Game.numPlayerCharacters<=0 ){
      ...
      System.out.println("Number of Players To Create: " + numPlayers);
      int i=0;
    ...
    System.out.println(winner.name().toUpperCase() + " WITH " + max + " POINTS");
    for (int i = 0; i<3; i++) System.out.println(".");
    System.out.println("CONGRATS " + winner.name().toUpperCase());
